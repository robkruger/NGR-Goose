...
if("TRUE" STREQUAL "TRUE")
  set(flexbe_states_SOURCE_PREFIX /home/mirte/NGR-Goose/mirte_ws/src/flexbe_behavior_engine/flexbe_states)
  set(flexbe_states_DEVEL_PREFIX /home/mirte/NGR-Goose/mirte_ws/devel/.private/flexbe_states)
  ...
  set(flexbe_states_INSTALL_PREFIX /home/mirte/NGR-Goose/mirte_ws/install)
...
if(NOT "/home/mirte/NGR-Goose/mirte_ws/src/flexbe_behavior_engine/flexbe_states/src " STREQUAL " ")
  set(flexbe_states_INCLUDE_DIRS "")
  set(_include_dirs "/home/mirte/NGR-Goose/mirte_ws/src/flexbe_behavior_engine/flexbe_states/src")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'flexbe_states' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mirte/NGR-Goose/mirte_ws/src/flexbe_behavior_engine/flexbe_states/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mirte/NGR-Goose/mirte_ws/devel/.private/flexbe_states/lib;/home/mirte/NGR-Goose/mirte_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(flexbe_states_EXPORTED_TARGETS ${${flexbe_states_dep}_EXPORTED_TARGETS})
endforeach()
