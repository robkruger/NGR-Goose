...
(cl:defmethod cl:initialize-instance :after ((m <EncoderData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EncoderData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<EncoderData> is deprecated: use gazebo_sensor_collection_plugins-msg:EncoderData instead.")))
...
(cl:defmethod id-val ((m <EncoderData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:id-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <EncoderData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:position-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <EncoderData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:speed-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'qpps-val :lambda-list '(m))
(cl:defmethod qpps-val ((m <EncoderData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:qpps-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:qpps instead.")
  (qpps m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EncoderData>)))
  ...
  "gazebo_sensor_collection_plugins/EncoderData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EncoderData)))
  "Returns string type for a message object of type 'EncoderData"
  "gazebo_sensor_collection_plugins/EncoderData")
