...
(cl:defmethod cl:initialize-instance :after ((m <EulerData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EulerData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<EulerData> is deprecated: use gazebo_sensor_collection_plugins-msg:EulerData instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <EulerData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:roll-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <EulerData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:pitch-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <EulerData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:yaw-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:yaw instead.")
  (yaw m))
