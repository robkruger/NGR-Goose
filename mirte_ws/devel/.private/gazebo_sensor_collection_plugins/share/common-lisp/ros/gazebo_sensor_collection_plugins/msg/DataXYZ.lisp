...
(cl:defmethod cl:initialize-instance :after ((m <DataXYZ>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DataXYZ)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<DataXYZ> is deprecated: use gazebo_sensor_collection_plugins-msg:DataXYZ instead.")))
