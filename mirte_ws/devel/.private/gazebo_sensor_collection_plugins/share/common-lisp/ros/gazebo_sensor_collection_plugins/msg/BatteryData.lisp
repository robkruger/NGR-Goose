...
(cl:defmethod cl:initialize-instance :after ((m <BatteryData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<BatteryData> is deprecated: use gazebo_sensor_collection_plugins-msg:BatteryData instead.")))
...
(cl:defmethod voltage-val ((m <BatteryData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:voltage-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'vmax-val :lambda-list '(m))
(cl:defmethod vmax-val ((m <BatteryData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:vmax-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:vmax instead.")
  (vmax m))

(cl:ensure-generic-function 'vmin-val :lambda-list '(m))
(cl:defmethod vmin-val ((m <BatteryData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:vmin-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:vmin instead.")
  (vmin m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BatteryData>)))
  ...
  "gazebo_sensor_collection_plugins/BatteryData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BatteryData)))
  "Returns string type for a message object of type 'BatteryData"
  "gazebo_sensor_collection_plugins/BatteryData")
