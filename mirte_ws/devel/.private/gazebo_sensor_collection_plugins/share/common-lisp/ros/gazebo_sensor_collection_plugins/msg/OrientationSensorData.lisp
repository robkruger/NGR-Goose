...
(cl:defclass <OrientationSensorData> (roslisp-msg-protocol:ros-message)
  ((x
   ...
   (covariance
    :reader covariance
    :initarg :covariance
    :type gazebo_sensor_collection_plugins-msg:EulerData
    :initform (cl:make-instance 'gazebo_sensor_collection_plugins-msg:EulerData))
   (bias
    :reader bias
    :initarg :bias
    :type gazebo_sensor_collection_plugins-msg:QuaternionData
    :initform (cl:make-instance 'gazebo_sensor_collection_plugins-msg:QuaternionData)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <OrientationSensorData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrientationSensorData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<OrientationSensorData> is deprecated: use gazebo_sensor_collection_plugins-msg:OrientationSensorData instead.")))
...
(cl:defmethod bias-val ((m <OrientationSensorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:bias-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:bias instead.")
  (bias m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OrientationSensorData>)))
  ...
  "gazebo_sensor_collection_plugins/OrientationSensorData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OrientationSensorData)))
  "Returns string type for a message object of type 'OrientationSensorData"
  "gazebo_sensor_collection_plugins/OrientationSensorData")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OrientationSensorData>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 w~%EulerData covariance~%QuaternionData bias~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/EulerData~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/QuaternionData~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OrientationSensorData)))
  "Returns full string definition for message of type 'OrientationSensorData"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 w~%EulerData covariance~%QuaternionData bias~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/EulerData~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/QuaternionData~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
