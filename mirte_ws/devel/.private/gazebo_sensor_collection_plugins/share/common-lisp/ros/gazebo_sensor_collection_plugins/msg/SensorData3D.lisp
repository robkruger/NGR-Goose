...
(cl:defmethod cl:initialize-instance :after ((m <SensorData3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SensorData3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_sensor_collection_plugins-msg:<SensorData3D> is deprecated: use gazebo_sensor_collection_plugins-msg:SensorData3D instead.")))
...
(cl:defmethod offset-val ((m <SensorData3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_sensor_collection_plugins-msg:offset-val is deprecated.  Use gazebo_sensor_collection_plugins-msg:offset instead.")
  (offset m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SensorData3D>)))
  ...
  "gazebo_sensor_collection_plugins/SensorData3D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SensorData3D)))
  "Returns string type for a message object of type 'SensorData3D"
  "gazebo_sensor_collection_plugins/SensorData3D")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SensorData3D>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%DataXYZ covariance~%DataXYZ bias~%DataXYZ offset~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/DataXYZ~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SensorData3D)))
  "Returns full string definition for message of type 'SensorData3D"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%DataXYZ covariance~%DataXYZ bias~%DataXYZ offset~%~%================================================================================~%MSG: gazebo_sensor_collection_plugins/DataXYZ~%float64 x~%float64 y~%float64 z~%~%~%"))
