...
class StateInstantiation {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.state_path);
    length += _getByteLength(object.state_class);
    length += _getByteLength(object.initial_state_name);
    ...
    length += _getByteLength(object.behavior_class);
