...
"""autogenerated by genpy from flexbe_msgs/UICommand.msg. Do not edit."""
import codecs
import sys
...
class UICommand(genpy.Message):
  _md5sum = "88f45469138737816fa9cd59fbf3c084"
  _type = "flexbe_msgs/UICommand"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Sends a command to the command interface of the FlexBE UI.
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UICommand, self).__init__(*args, **kwds)
