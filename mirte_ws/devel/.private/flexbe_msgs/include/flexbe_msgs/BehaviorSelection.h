...
struct BehaviorSelection_
{
  ...
  _input_values_type input_values;
   ...
   typedef std::vector< ::flexbe_msgs::BehaviorModification_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::flexbe_msgs::BehaviorModification_<ContainerAllocator> >> _modifications_type;
