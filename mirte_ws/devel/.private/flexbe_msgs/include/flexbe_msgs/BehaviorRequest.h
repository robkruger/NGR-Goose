...
struct BehaviorRequest_
{
  ...
  _arg_values_type arg_values;
   ...
   typedef std::vector< ::flexbe_msgs::Container_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::flexbe_msgs::Container_<ContainerAllocator> >> _structure_type;
