...
struct BehaviorSynthesisResult_
{
  ...
  _error_code_type error_code;
   ...
   typedef std::vector< ::flexbe_msgs::StateInstantiation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::flexbe_msgs::StateInstantiation_<ContainerAllocator> >> _states_type;
  _states_type states;
