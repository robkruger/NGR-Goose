...
class IntensityDigital {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new IntensityDigital(null);
  ...
  static datatype() {
    ...
    return 'mirte_msgs_2/IntensityDigital';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntensityDigital(null);
...
module.exports = IntensityDigital;
