...
class GetRangeRequest {
  ...
  static datatype() {
    ...
    return 'mirte_msgs_2/GetRangeRequest';
  }
...
class GetRangeResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mirte_msgs_2/GetRangeResponse';
  }
...
module.exports = {
  ...
  md5sum() { return 'b3ee9ed25575b46bb47c7673ad202faa'; },
  datatype() { return 'mirte_msgs_2/GetRange'; }
};
