...
(cl:defmethod cl:initialize-instance :after ((m <color>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'color)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-msg:<color> is deprecated: use mirte_msgs_2-msg:color instead.")))

(cl:ensure-generic-function 'red-val :lambda-list '(m))
(cl:defmethod red-val ((m <color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-msg:red-val is deprecated.  Use mirte_msgs_2-msg:red instead.")
  (red m))

(cl:ensure-generic-function 'green-val :lambda-list '(m))
(cl:defmethod green-val ((m <color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-msg:green-val is deprecated.  Use mirte_msgs_2-msg:green instead.")
  (green m))

(cl:ensure-generic-function 'blue-val :lambda-list '(m))
(cl:defmethod blue-val ((m <color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-msg:blue-val is deprecated.  Use mirte_msgs_2-msg:blue instead.")
  (blue m))
