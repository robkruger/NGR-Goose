...
(cl:defmethod cl:initialize-instance :after ((m <GetRange-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetRange-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetRange-request> is deprecated: use mirte_msgs_2-srv:GetRange-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetRange-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetRange-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetRange-response> is deprecated: use mirte_msgs_2-srv:GetRange-response instead.")))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <GetRange-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:min-val is deprecated.  Use mirte_msgs_2-srv:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <GetRange-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:max-val is deprecated.  Use mirte_msgs_2-srv:max instead.")
  (max m))
