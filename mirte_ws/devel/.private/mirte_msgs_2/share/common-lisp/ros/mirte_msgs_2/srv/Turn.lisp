...
(cl:defmethod cl:initialize-instance :after ((m <Turn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<Turn-request> is deprecated: use mirte_msgs_2-srv:Turn-request instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Turn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:angle-val is deprecated.  Use mirte_msgs_2-srv:angle instead.")
  (angle m))
...
(cl:defmethod cl:initialize-instance :after ((m <Turn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<Turn-response> is deprecated: use mirte_msgs_2-srv:Turn-response instead.")))
