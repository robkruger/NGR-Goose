...
(cl:in-package mirte_msgs_2-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetPinValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPinValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<SetPinValue-request> is deprecated: use mirte_msgs_2-srv:SetPinValue-request instead.")))

(cl:ensure-generic-function 'pin-val :lambda-list '(m))
(cl:defmethod pin-val ((m <SetPinValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:pin-val is deprecated.  Use mirte_msgs_2-srv:pin instead.")
  (pin m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <SetPinValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:type-val is deprecated.  Use mirte_msgs_2-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetPinValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:value-val is deprecated.  Use mirte_msgs_2-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPinValue-request>)))
  ...
  "mirte_msgs_2/SetPinValueRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPinValue-request)))
  "Returns string type for a service object of type 'SetPinValue-request"
  "mirte_msgs_2/SetPinValueRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPinValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPinValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<SetPinValue-response> is deprecated: use mirte_msgs_2-srv:SetPinValue-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <SetPinValue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:status-val is deprecated.  Use mirte_msgs_2-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPinValue-response>)))
  ...
  "mirte_msgs_2/SetPinValueResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPinValue-response)))
  "Returns string type for a service object of type 'SetPinValue-response"
  "mirte_msgs_2/SetPinValueResponse")
