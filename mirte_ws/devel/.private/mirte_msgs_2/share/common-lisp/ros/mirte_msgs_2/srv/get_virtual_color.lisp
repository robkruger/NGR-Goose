...
(cl:defmethod cl:initialize-instance :after ((m <get_virtual_color-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_virtual_color-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<get_virtual_color-request> is deprecated: use mirte_msgs_2-srv:get_virtual_color-request instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <get_virtual_color-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:direction-val is deprecated.  Use mirte_msgs_2-srv:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_virtual_color-request>)))
  ...
  "mirte_msgs_2/get_virtual_colorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_virtual_color-request)))
  "Returns string type for a service object of type 'get_virtual_color-request"
  "mirte_msgs_2/get_virtual_colorRequest")
...
(cl:defclass <get_virtual_color-response> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type mirte_msgs_2-msg:color
    :initform (cl:make-instance 'mirte_msgs_2-msg:color)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <get_virtual_color-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_virtual_color-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<get_virtual_color-response> is deprecated: use mirte_msgs_2-srv:get_virtual_color-response instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <get_virtual_color-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:data-val is deprecated.  Use mirte_msgs_2-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<get_virtual_color-response>)))
  ...
  "mirte_msgs_2/get_virtual_colorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_virtual_color-response)))
  "Returns string type for a service object of type 'get_virtual_color-response"
  "mirte_msgs_2/get_virtual_colorResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<get_virtual_color-response>)))
  ...
  (cl:format cl:nil "mirte_msgs_2/color data~%~%~%================================================================================~%MSG: mirte_msgs_2/color~%int32 red~%int32 green~%int32 blue~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'get_virtual_color-response)))
  "Returns full string definition for message of type 'get_virtual_color-response"
  (cl:format cl:nil "mirte_msgs_2/color data~%~%~%================================================================================~%MSG: mirte_msgs_2/color~%int32 red~%int32 green~%int32 blue~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'get_virtual_color)))
  ...
  "mirte_msgs_2/get_virtual_color")