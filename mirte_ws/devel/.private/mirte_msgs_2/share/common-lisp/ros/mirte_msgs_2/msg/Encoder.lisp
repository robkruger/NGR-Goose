...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-msg:<Encoder> is deprecated: use mirte_msgs_2-msg:Encoder instead.")))
...
(cl:defmethod value-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-msg:value-val is deprecated.  Use mirte_msgs_2-msg:value instead.")
  (value m))
