...
(cl:defmethod cl:initialize-instance :after ((m <Intensity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Intensity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-msg:<Intensity> is deprecated: use mirte_msgs_2-msg:Intensity instead.")))
