...
(cl:defmethod cl:initialize-instance :after ((m <IntensityDigital>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntensityDigital)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-msg:<IntensityDigital> is deprecated: use mirte_msgs_2-msg:IntensityDigital instead.")))
