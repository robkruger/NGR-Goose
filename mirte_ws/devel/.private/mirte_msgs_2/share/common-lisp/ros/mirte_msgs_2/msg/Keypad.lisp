...
(cl:defmethod cl:initialize-instance :after ((m <Keypad>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Keypad)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-msg:<Keypad> is deprecated: use mirte_msgs_2-msg:Keypad instead.")))
...
(cl:defmethod key-val ((m <Keypad>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-msg:key-val is deprecated.  Use mirte_msgs_2-msg:key instead.")
  (key m))
