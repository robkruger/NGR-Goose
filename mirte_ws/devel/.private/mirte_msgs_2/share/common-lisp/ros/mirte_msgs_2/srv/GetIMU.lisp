...
(cl:defmethod cl:initialize-instance :after ((m <GetIMU-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetIMU-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetIMU-request> is deprecated: use mirte_msgs_2-srv:GetIMU-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetIMU-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetIMU-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetIMU-response> is deprecated: use mirte_msgs_2-srv:GetIMU-response instead.")))
