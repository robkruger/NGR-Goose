...
(cl:defmethod cl:initialize-instance :after ((m <GetKeypad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetKeypad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetKeypad-request> is deprecated: use mirte_msgs_2-srv:GetKeypad-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetKeypad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetKeypad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<GetKeypad-response> is deprecated: use mirte_msgs_2-srv:GetKeypad-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetKeypad-response>)))
  ...
  "mirte_msgs_2/GetKeypadResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetKeypad-response)))
  "Returns string type for a service object of type 'GetKeypad-response"
  "mirte_msgs_2/GetKeypadResponse")
