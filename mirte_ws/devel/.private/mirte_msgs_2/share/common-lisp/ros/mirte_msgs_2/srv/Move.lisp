...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<Move-request> is deprecated: use mirte_msgs_2-srv:Move-request instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:distance-val is deprecated.  Use mirte_msgs_2-srv:distance instead.")
  (distance m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:speed-val is deprecated.  Use mirte_msgs_2-srv:speed instead.")
  (speed m))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mirte_msgs_2-srv:<Move-response> is deprecated: use mirte_msgs_2-srv:Move-response instead.")))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <Move-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mirte_msgs_2-srv:finished-val is deprecated.  Use mirte_msgs_2-srv:finished instead.")
  (finished m))
